  ...
  return (
    <div className="rounded-xl border border-gray-800 bg-[#161920] p-6">
      ...
      <div className="mt-4 space-y-3">
        {alerts.length === 0 ? (
          <p className="text-xs text-gray-500">ไม่มีสินค้าที่ต้องแจ้งเตือน</p>
        ) : (
      ...
      {hasMore && (
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-1.5 border border-gray-700 py-2 text-xs font-semibold uppercase tracking-wider text-gray-400 transition-colors hover:border-amber-600 hover:text-amber-400"
        >
          {showAll ? (
            <>
